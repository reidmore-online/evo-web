...
export const EbayIconAuthenticityGuaranteeFilled16Colored: EbayIconComponent = props => (
    <EbayIcon {...props} name="authenticityGuaranteeFilled16Colored" __type="icon" __symbol={SYMBOL} />
);