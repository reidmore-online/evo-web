...
const meta: Meta<typeof EbayTable> = {
    ...
    argTypes: {
        ...
        columnType: {
            description: "Column type, `normal`, `numeric`, `layout`, `icon-action`",
            options: ["normal", "numeric", "layout", "icon-action"],
            control: { type: "select" },
        },
        name: { description: "Column name that will be used in the EbayTable event `sorted` object", control: "text" },
        sort: {
            description: "Defines which icon will be shown, `asc`, `desc`, `none`",
            options: ["asc", "desc", "none"],
            control: { type: "select" },
        },
        rowHeader: { description: "Defines if the column is a row header", control: "boolean" },
        selected: { description: "Defines if the row is selected", control: "boolean" },
    },
