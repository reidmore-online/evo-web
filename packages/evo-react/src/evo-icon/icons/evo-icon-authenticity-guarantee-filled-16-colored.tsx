...
export function EvoIconAuthenticityGuaranteeFilled16Colored(props: EvoIconComponentProps) {
  return <EvoIcon {...props} __name="authenticityGuaranteeFilled16Colored" __symbol={SYMBOL} />;
}
