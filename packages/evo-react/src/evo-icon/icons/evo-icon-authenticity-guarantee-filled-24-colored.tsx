...
export function EvoIconAuthenticityGuaranteeFilled24Colored(props: EvoIconComponentProps) {
  return <EvoIcon {...props} __name="authenticityGuaranteeFilled24Colored" __symbol={SYMBOL} />;
}
